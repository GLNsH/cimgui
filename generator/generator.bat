...
::-DIMGUI_USE_WCHAR32 should not be used (is discarded) glfw opengl3 opengl2 sdl2 sdl3 vulkan
luajit ./generator.lua gcc "internal comments noimstrv" glfw opengl3 opengl2 %*
